...
const Contact = () => {
  return (
    <div className='bg-gradient-to-r from-[#fffbee] to to-white py-16 py-28'>
      <form className="flex flex-col items-center text-sm text-slate-800">
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <textarea rows="4" className="w-full mt-2 p-2  border-slate-300 bg-secondary/10 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-black/80 transition-all" placeholder="Enter your message" required></textarea>

          <button type="submit" className="flexCenter gap-1 mt-5 btn-secondary w-full font-bold">
            Submit Form
            <img src={assets.right} alt="" className='invert-50' />
          </button>
        </div>
      </form>
