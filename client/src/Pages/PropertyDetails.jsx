...
const PropertyDetails = () => {
  ...
  return (
    property && (
      <div className='bg-gradient-to-r from-[#fffbee] to-white py-16 py-28'>
        <div className='max-padd-container'>
            ...
            <div className='p-4 flex-2 rounded-xl border border-slate-900/10'>
              ...
              < div className='flex justify-between items-start my-1 '>
                ...
                <div className='flex items-baseline gap-2 text-secondary relative top-1.5'>
                  <h4 className='bold-18 relative bottom-0.5 text-black'>5.0
                  </h4>
              ...
              <div className='flex gap-x-4 mt-3'>
                <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-500'>
                  <img src={assets.bed} alt="" width={19} /> {property.facilities.bedrooms}
                </p>
                <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                  <img src={assets.bath} alt="" width={19} /> {property.facilities.bathrooms}
                </p>
                <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                  <img src={assets.car} alt="" width={19} /> {property.facilities.garages}
                </p>
                <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                  <img src={assets.ruler} alt="" width={19} /> 400
                </p>
              </div>
              <div className='mt-6'>
              ...
              <form className=' text-gray-500 bg-secondary/10 rounded-lg px-6 py-4 flex flex-col lg:flex-row gap-4 max-w-md lg:max-w-full ring-1 ring-slate-900/5 relative mt-10'>
                ...
                <div className='flex flex-col w-full'>
                  ...
                  <input type="date" id='checkOut' className='rounded bg-secondary/10 border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none' />
                </div>
                <div className='flex flex-col w-full'>
                  <div className='flex items-center gap-2'>
                  ...
                  <input id='guests' type='number' min={1} max={5} className='rounded bg-secondary/10 border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none' placeholder='0' />
                </div>
          ...
          <div>
            ...
            <form className='flex flex-col gap-4'>
              <input type="text" placeholder='Your Name' className='p-2 py-1 border border-gray-300 rounded-md text-sm' required/>
              <input type="email" placeholder='Your Email' className='p-2 py-1 border border-gray-300 rounded-md text-sm' required/>
              <textarea row={4} placeholder='Your Message' className='p-2 py-1 border border-gray-300 rounded-md text-sm' required/>
              <button type="submit" className='btn-secondary rounded-lg py-1.5 '>Send Message</button>
            </form>
            <h4 className='h4 mb-3 mt-8'></h4>
              <div>
                <div>
                  <div>
                    <div>
                ...
                <div className='flexStart gap-2 p-1.5'>
                  ...
                  <div><p>{property.agency.contact}</p></div>
                  </div>
