  ...
  return (
    <div className='bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28'>
      <div className='max-padd-container'>
        {/*container*/}
        <div className='grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 gap-y-12'>
          {blogs.map((blog, index) => (
            <div key={index} className='relative'>
              ...
              <button className='underline mt-2 bold-14 line-clamp-2'>continue</button>
            </div>
          ))}
        </div>
      </div>
