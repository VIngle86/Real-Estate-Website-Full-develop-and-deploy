            ...
            <div className='max-padd-container'>
                <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                    ...
                    <div className='max-w-80'>
                        ...
                        <div className='flex items-centerflex items-center border pl-4 gap-2 bg-white border-gray-500/30 h-11.5 rounded-full overflow-hidden max-w-md w-full mt-6 '>
