  ...
  return (
    <section className="max-padd-container py-16 xl:py-22">
      ...
      <div className='flexBetween mt-8 mb-6'>
        ...
        <Link to={'/listing'} onClick={() => scrollTo(0, 0)} className='bg-secondary/10 ring-1 ring-slate-900/15 text-white text-2xl rounded-md p-2 flexCenter'><img src={assets.sliders} alt='' />
        </Link>
      </div>
