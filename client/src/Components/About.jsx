    ...
    <section className='max-padd-container py-16 xl:py-28 pt-36'>
      ...
      <div className='flex items-center flex-col lg:flex-row gap-12'>
        <div className='flex-1'>
          ...
          <Title title1={"Your Trusted Real Estate Partner"}
          ...
          <div className='flex flex-col gap-6 mt-5'>
            ...
            <div>
              {/*Rating*/}
              <div className='flex item-center divide-x divide-gray-300 mt-11'>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center divide-x divide-gray-300 mt-11">
            ...
            <div className="pl-3">
              ...
              <p className="text-sm text-gray-500">Trusted by{""} <span className="font-medium text-gray-800">100,000+</span> users
              </p>
            </div>
          </div>
        </div>
